...
import services as _services, schemas as _schemas, database as _database, models as _models
...
async def update_lead(lead: _schemas.LeadCreate,lead_id: int,user: _schemas.User = _fastapi.Depends(_services.get_current_user),
db:_orm.Session = _fastapi.Depends(_services.get_db)):
